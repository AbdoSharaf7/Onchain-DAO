...
export default function Home() {
  ...
  // Fetch the Blue NFT balance of the user
  const nftBalanceOfUser = useReadContract({
    abi: BlueNFTABI,
    address: BlueNFTAddress,
  ...
  function renderCreateProposalTab() {
    if (loading) {
      ...
      return (
        <div className={styles.description}>
          You do not own any Blue NFTs. <br />
  ...
  return (
    <div className={inter.className}>
      <Head>
        <title>Blue DAO</title>
        <meta name="description" content="Blue DAO" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to BlueDAO!</h1>
          <div className={styles.description}>Welcome to the DAO!</div>
          <div className={styles.description}>
            Your Blue NFT Balance:{" "}
